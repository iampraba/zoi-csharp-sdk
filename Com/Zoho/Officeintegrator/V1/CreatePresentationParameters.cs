...
namespace Com.Zoho.Officeintegrator.V1
{
	...
	public class CreatePresentationParameters : Model
	{
		private string url;
		...
		public ZohoShowEditorSettings EditorSettings
		{
			/// <summary>The method to get the editorSettings</summary>
			/// <returns>Instance of ZohoShowEditorSettings</returns>
			get
			{
			...
			/// <param name="editorSettings">Instance of ZohoShowEditorSettings</param>
			set
			{
