...
namespace Com.Zoho.Officeintegrator.V1
{
	...
	public class AllSessionsResponse : Model, WriterResponseHandler
	{
		...
		public List<SessionMeta> Sessions
		{
			/// <summary>The method to get the sessions</summary>
			/// <returns>Instance of List<SessionMeta></returns>
			get
			{
				return  this.sessions;

			}
			/// <summary>The method to set the value to sessions</summary>
			/// <param name="sessions">Instance of List<SessionMeta></param>
			set
			{
				 this.sessions=value;
