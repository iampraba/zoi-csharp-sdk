...
namespace Com.Zoho.Officeintegrator.V1
{
	...
	public class CreateSheetParameters : Model
	{
		private string url;
		private StreamWrapper document;
		private SheetCallbackSettings callbackSettings;
		private SheetEditorSettings editorSettings;
		private Dictionary<string, object> permissions;
		private DocumentInfo documentInfo;
		private SheetUserSettings userInfo;
		private SheetUiOptions uiOptions;
		...
		public SheetCallbackSettings CallbackSettings
		{
			/// <summary>The method to get the callbackSettings</summary>
			/// <returns>Instance of SheetCallbackSettings</returns>
			get
			{
			...
			/// <param name="callbackSettings">Instance of SheetCallbackSettings</param>
			set
			{
		...
		public SheetEditorSettings EditorSettings
		{
			/// <summary>The method to get the editorSettings</summary>
			/// <returns>Instance of SheetEditorSettings</returns>
			get
			{
			...
			/// <param name="editorSettings">Instance of SheetEditorSettings</param>
			set
			{
		...
		public SheetUserSettings UserInfo
		{
			/// <summary>The method to get the userInfo</summary>
			/// <returns>Instance of SheetUserSettings</returns>
			get
			{
			...
			/// <param name="userInfo">Instance of SheetUserSettings</param>
			set
			{
				 this.userInfo=value;
		...
		public SheetUiOptions UiOptions
		{
			/// <summary>The method to get the uiOptions</summary>
			/// <returns>Instance of SheetUiOptions</returns>
			get
			{
			...
			/// <param name="uiOptions">Instance of SheetUiOptions</param>
			set
			{
