...
namespace Com.Zoho
{
    ...
    public class Initializer : IDisposable
    {
        ...
        /// </summary>
        /// <param name="user">A User class instance represents the user.</param>
        /// <param name="environment">A Environment class instance containing the API base URL and Accounts URL.</param>
        ...
        private static void Initialize(UserSignature user, Dc.DataCenter.Environment environment, Token token, TokenStore store, SDKConfig sdkConfig, Logger logger, RequestProxy proxy)
        {
            try
            {
        ...
        /// <summary>
        /// This is a getter method to get User.
        /// </summary>
        /// <returns>A User class instance representing the user.</returns>
