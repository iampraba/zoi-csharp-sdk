...
namespace Com.Zoho.Util
{
    ...
    public static class Constants
    {
        ...
        public static readonly string CHOICE_NAMESPACE = "Com.Zoho.Util.Choice";
        ...
        public static readonly string STREAM_WRAPPER_CLASS_PATH = "Com.Zoho.Util.StreamWrapper";

        public static readonly string FILE_NAMESPACE = "Com.Zoho.Util.StreamWrapper";
        ...
        public static readonly string OPTION_NAMESPACE = "Com.Zoho.Util.Option";

        public static readonly string PACKAGE_NAMESPACE = "Com.Zoho";
